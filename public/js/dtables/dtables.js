...
var threshold  = 180;
   ...
   function set_sheet_corners(){
       ...
       height=img.height;
       width=img.width;
       var x11=(1300/1660)*width-(width-corners[1]);
       var v1 = verticalAxes(corners[2]+(20/2340)*height,(400/2340)*height+corners[2],x11,(20/2340)*height,(9/2340)*height);
       var y21=(150/2340)*height+corners[2];
       var h1 = horizontalAxes(corners[1]-(400/1660)*width,corners[1]-(20/1660)*width,y21,(20/1660)*width,(9/1660)*width);
       var x12=(1500/1660)*width-(width-corners[1]);
       var v2 = verticalAxes(corners[2]+(20/2340)*height,(400/2340)*height+corners[2],x12,(20/2340)*height,(9/2340)*height);
       var y22=(350/2340)*height+corners[2];
       var h2 = horizontalAxes(corners[1]-(400/1660)*width,corners[1]-(20/1660)*width,y22,(20/1660)*width,(9/1660)*width);
       var x13=(1300/1660)*width-(width-corners[1]);
       var v3 = verticalAxes(corners[3]-(400/2340)*height,corners[3]-(20/2340)*height,x13,(20/2340)*height,(9/2340)*height);
       var y23=(1920/2340)*height-(height-corners[3]);
       var h3 = horizontalAxes(corners[1]-(400/1660)*width,corners[1]-(20/1660)*width,y23,(20/1660)*width,(9/1660)*width);
       var x14=(1500/1660)*width-(width-corners[1]);
       var v4 = verticalAxes(corners[3]-(400/2340)*height,corners[3]-(20/2340)*height,x14,(20/2340)*height,(9/2340)*height);
       var y24=(2120/2340)*height-(height-corners[3]);
       var h4 = horizontalAxes(corners[1]-(400/1660)*width,corners[1]-(20/1660)*width,y24,(20/1660)*width,(9/1660)*width);
       ...
       degrees = Math.atan(1*(i4[0]-i2[0])/(i4[1]-i2[1]));
       ...
       var i3 = intersection(v3[(v3.length)-1],v4[(v4.length)-1],x13,x14,y23,y21,h3[0],h1[0]);
       var i4 = intersection(v3[(v3.length)-1],v4[(v4.length)-1],x13,x14,y24,y22,h4[(h4.length)-1],h2[(h2.length)-1]);
       sheet_corners = new Path(width,height, "red", 1, ctx);
       ...
       dx = i4[1] - i2[1];
       dy = i4[1] - i2[1];
       width = Math.round((20/1660)*width);
       height = Math.round((20/2340)*height);
       radius = Math.round((10/1660)*width);
       $("#width").val(width);
       $("#height").val(height);
       $("#radius").val(radius);
       init();
