...
<div id="redForm_run" hidden>
    <button type="button" id="run">FormRead</button>
    {{ __('messages.markDarkness') }}<input type="number" min="0" max="100" id="darkness" value="30">
     {{ __('messages.OCRLanguage') }}<select id="langsel" onchange="window.lastFile && recognizeFile(window.lastFile)">
